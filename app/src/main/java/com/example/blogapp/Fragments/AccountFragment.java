            ...
            try {
                ...
                if (object.getBoolean("success")){
                    ...
                    for (int i = 0; i < posts.length(); i++) {
                        ...
                        Post post  = new Post();
                        post.setPhoto(Constant.URL+"posts/"+p.getString("photo"));
                        arrayList.add(post);
                    ...
                    Picasso.get().load(Constant.URL+"storage/"+user.getString("photo")).into(imgProfile);
                    adapter = new AccountPostAdapter(getContext(),arrayList);
                    recyclerView.setAdapter(adapter);
                    imgUrl = Constant.URL+"storage/"+user.getString("photo");
                }
